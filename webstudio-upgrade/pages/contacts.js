				...
				<div className="container contacts__container">
					...
					<div className="contacts-info__container">
						...
						<p className="contacts-subtitle">
							Мы веб-студия разработки, предлагающая качественные и
							инновационные решения для вашего онлайн присутствия. Наша команда
							состоит из опытных разработчиков, дизайнеров и маркетологов,
							которые стремятся помочь вам достичь ваших целей.
							<br />
							...
							взаимодействии с клиентами, чтобы полностью понять их потребности
							и создать индивидуальные решения, которые подходят их бизнесу.
							<br />
